...
class Order extends Page {
    constructor(pageSpecs={}) {
        super(pageSpecs)
        if (this.changeHistory) orinoco.pageManager.changePage("oriKids : votre panier", "panier", this);
    ...
    template(){
      return `
      <div id="panier"></div>
      <div id="total">Le montant total de votre commande est de : €</div>
      <form id="formulaire">
        <div class="form-row">
        ...
        <button type="button" id="valider" href="confirmation.html">
          Valider
        </button>
      </form>
